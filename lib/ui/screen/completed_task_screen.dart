...
//     return Scaffold(
//       body: Text("Completed task screen"),
//     );
//   }
// }
import 'package:flutter/material.dart';
...
class CompletedTaskScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Completed Tasks"), backgroundColor: Colors.green),
      body: Consumer<ListController>(
        builder: (context, listController, child) {
          // Filter tasks with status "Completed"
          List<Map<String, dynamic>> completedTasks =
          listController.list.where((task) => task["status"] == "Completed").toList();
